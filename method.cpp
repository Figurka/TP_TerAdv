...
int Enemy::kick(Player p){

if (getRect().intersects(p.getRect()))//если прямоугольник спрайта объекта пересекается с игроком
          {
            if (name == "EasyEnemy") {//и при этом имя объекта EasyEnemy,то..
              //if (dx>0)//если враг идет вправо
              //{
              // x = smth.x - smth.w; //отталкиваем его от игрока влево (впритык)
              //  dx = 0;//останавливаем
              //}
              //if (dx < 0)//если враг идет влево
              //{
              //  x = smth.x + smth.w; //аналогично - отталкиваем вправо
              //  dx = 0;//останавливаем
              //}
              //if(dy>0)
              //{
              //  y = smth.y - smth.h; //отталкиваем его от игрока влево (впритык)
              //  dy = 0;//останавливаем
              //  
              //}
              //if (dy<0)
